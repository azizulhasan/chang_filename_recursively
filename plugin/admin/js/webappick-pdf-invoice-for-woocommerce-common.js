            ...
            $("#doaction, #doaction2").click(
                function (event) {
                    ...
                    if(getAction==="wpifw_bulk_invoice") {
                        ...
                        var URL;
                        if (challan_ajax_obj_2.challan_ajax_url_2.indexOf("?") != -1) {
                            URL = challan_ajax_obj_2.challan_ajax_url_2+'&action=wpifw_generate_invoice&order_ids='+order_ids+'&_wpnonce='+challan_ajax_obj_2.nonce;
                        } else {
                            URL = challan_ajax_obj_2.challan_ajax_url_2+'?action=wpifw_generate_invoice&order_ids='+order_ids+'&_wpnonce='+challan_ajax_obj_2.nonce;
                        }
                        ...
                        var URL;
                        if (challan_ajax_obj_2.challan_ajax_url_2.indexOf("?") != -1) {
                            URL = challan_ajax_obj_2.challan_ajax_url_2+'&action=wpifw_generate_invoice_packing_slip&order_ids='+order_ids+'&_wpnonce='+challan_ajax_obj_2.nonce;
                        } else {
                            URL = challan_ajax_obj_2.challan_ajax_url_2+'?action=wpifw_generate_invoice_packing_slip&order_ids='+order_ids+'&_wpnonce='+challan_ajax_obj_2.nonce;
                        }
