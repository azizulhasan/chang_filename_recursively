...
! function (t, e) {
    ...
    var we = "dropdown",
        ...
        Re = ".challan-dropdown form",
        Fe = ".challan-dropdown-menu",
        Me = ".challan-navbar-nav",
        We = ".challan-dropdown-menu .challan-dropdown-item:not(.disabled):not(:disabled)",
        Ue = "top-start",
        Be = "top-end",
        qe = "bottom-start",
        Ke = "bottom-end",
        ...
        ze = function () {
            ...
            return t.toggle = function () {
                ...
                return 0 < p(this._element).closest(".challan-navbar").length
    ...
    var Ge = "modal",
        ...
        on = "challan-modal-scrollbar-measure",
        rn = "challan-modal-backdrop",
        sn = "challan-modal-open",
        an = "fade",
        ln = "show",
        cn = ".challan-modal-dialog",
        hn = '[data-toggle="modal"]',
        un = '[data-dismiss="modal"]',
        fn = ".challan-fixed-top, .challan-fixed-bottom, .challan-is-fixed, .challan-sticky-top",
        dn = ".challan-sticky-top",
        pn = function () {
            function o(t, e)
            {
    ...
    var mn = "tooltip",
        ...
        Hn = function () {
            ...
            return t.enable = function () {
                ...
                clearTimeout(this._timeout), p.removeData(this.element, this.constructor.DATA_KEY), p(this.element).off(this.constructor.EVENT_KEY), p(this.element).closest(".challan-modal").off("hide.bs.challan-modal"), this.tip && p(this.tip).remove(), this._isEnabled = null, this._timeout = null, this._hoverState = null, (this._activeTrigger = null) !== this._popper && this._popper.destroy(), this._popper = null, this.element = null, this.config = null, this.tip = null
            }, t.show = function () {
                var e = this;
                ...
                ), p(this.element).closest(".challan-modal").on(
                    "hide.bs.challan-modal", function () {
                            i.element && i.hide()
                    }
    ...
    var Gn = "scrollspy",
        ...
        oi = "active",
        ri = '[data-spy="scroll"]',
        si = ".challan-nav, .list-group",
        ai = ".challan-nav-link",
        li = ".challan-nav-item",
        ci = ".list-group-item",
        hi = ".challan-dropdown",
        ui = ".challan-dropdown-item",
        fi = ".challan-dropdown-toggle",
        di = "offset",
        pi = "position",
        mi = function () {
            function n(t, e)
    ...
    var gi = "bs.tab",
        ...
        Ci = "show",
        Si = ".challan-dropdown",
        Di = ".challan-nav, .list-group",
        Ii = ".active",
        Ai = "> li > .active",
        Oi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',
        Ni = ".challan-dropdown-toggle",
        ki = "> .challan-dropdown-menu .active",
        Li = function () {
            function i(t)
            {
                this._element = t
