 ...
 *
 * @package    Challan
 * @subpackage Challan/admin/partials
 */

// Checkbox Value to compare.
$challan_current = 1;

$challan_logo_dir   = plugin_dir_url( dirname( __FILE__ ) ) . 'images/challan-logo.svg';
$challan_banner_dir = plugin_dir_url( dirname( __FILE__ ) ) . 'images/get-challan-pro.svg';

$challan_style  = 'max-width:80%;display:block;margin:0 auto;border: 3px solid #0F74A6;';
$challan_style2 = 'max-width:80%;display:block;margin:0 auto;border: 3px solid #1AA15F;';


if ( substr( get_option( 'wpifw_logo_attachment_id' ), 0, 7 ) === 'http://' || substr( get_option( 'wpifw_logo_attachment_id' ), 0, 8 ) === 'https://' ) {
	$challan_image_id       = attachment_url_to_postid( get_option( 'wpifw_logo_attachment_id' ) );
	$challan_full_size_path = get_attached_file( $challan_image_id );
	update_option( 'wpifw_logo_attachment_id', $challan_full_size_path );
	update_option( 'wpifw_logo_attachment_image_id', $challan_image_id );
}
...
<?php
//Promotion area
//$hide_promotion = (int) get_option('challan_hide_promotion');
//
//if( 1 !== $hide_promotion && empty($hide_promotion) ) { ?>
<!--    <div class="challan-promotion">-->
<!--        <a target="_blank" href="https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=challan_free">-->
<!--            <img src="--><?php //echo esc_url( 'https://challan-assets.s3.amazonaws.com/black-friday-challan.gif' );?><!--" alt="Challan Pro Black Friday">-->
<!--        </a>-->
<!--        <span class="dashicons dashicons-no-alt challan-campaign-close-button" data-condition="1"></span>-->
<!--    </div>-->
<?php //} ?>

<div class="challan-wrap">
    <div class="challan-dashboard-header">
        <a class="wapk-challan-admin-logo"
           href="<?php echo esc_url( 'https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=challan_free' ); ?>"
           target="_blank"><img
                    src="<?php echo esc_url( $challan_logo_dir ); ?>" alt="Challan"></a>
        <a class="wapk-challan-get-product-btn"
           href="<?php echo esc_url( 'https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=challan_free' ); ?>"
           target="_blank"><img
                    src="<?php echo esc_url( $challan_banner_dir ); ?>" alt="Challan"></a>
        ...
        <a class="wapk-challan-support-btn" target="_blank"
        ...
        <a class="wapk-challan-support-btn documentation" target="_blank"
           href="<?php echo esc_url( 'https://webappick.com/docs/' ); ?>"><?php esc_html_e( 'Documentation', 'webappick-pdf-invoice-for-woocommerce' ); ?></a>

    </div><!-- end .challan-dashboard-header -->
    <div class="challan-dashboard-body">
        <div class="challan-dashboard-sidebar">
            <div class="challan-sidebar-navbar challan-sidebar-navbar-vertical challan-fixed-left challan-sidebar-navbar-expand-md challan-sidebar-navbar-light"
                 id="challan-sidebar">
                <div class="container-fluid">
                    <!-- Toggler -->
                    <button class="challan-sidebar-navbar-toggler" type="button" data-toggle="collapse"
                            data-target="#webappickSidebarCollapse" aria-controls="webappickSidebarCollapse"
                            aria-expanded="false" aria-label="Toggle challan-navigation">
                        <span class="challan-sidebar-navbar-toggler-icon"></span>
                    </button>

                    <!-- Brand -->
                    <!-- <a class="challan-sidebar-navbar-brand" href="https://webappick.com"><img src="../wp-content/plugins/challan-boilerplate/admin/images/challan-logo.png" alt="WEBAPPICK" style="width:100px;"></a> -->

                    <!-- Collapse -->
                    <ul class="collapse challan-sidebar-navbar-collapse" id="webappickSidebarCollapse">

                        <ul class="challan-sidebar-navbar-nav challan-mb-md-4">
                            <li class="challan-sidebar-nav-item">
                                <a class="challan-sidebar-nav-link" href="#">
                            ...
                            <li class="challan-sidebar-nav-item" style="display: none;">
                                <a class="challan-sidebar-nav-link" href="#">
        ...
        </div><!-- end .challan-dashboard-sidebar -->
        <div class="challan-dashboard-content">
            <!--START SETTING TAB-->
            <li>
                <div class="challan-row">
                    <div class="challan-col-sm-8 challan-col-12">
                        <div class="challan-card challan-mr-0">
                            <div class="challan-card-body">
                                <form action="" method="post">
									<?php wp_nonce_field( 'invoice_form_nonce' ); ?>
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Enable Invoicing', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container"
                                                 tooltip="Enable Invoicing to generate automatically." flow="right">
                                                <input type="hidden" name="wpifw_invoicing" value="0">
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       id="wpifw_invoicing" name="wpifw_invoicing"
                                                       value="1" <?php checked( get_option( 'wpifw_invoicing' ), $challan_current, true ); ?>>
                                                <label class="challan-custom-control-label"
                                                       for="wpifw_invoicing"></label>
                                            </div>
                                        </div>
                                    </div><!-- end .challan-form-group -->
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Allow My Account To Download Invoice', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container"
                                                ...
                                                <input title="Allow Customer to Download Invoice From My Account"
                                                       type="checkbox" class="challan-custom-control-input"
                                                       id="wpifw_download" name="wpifw_download"
                                                       value="1" <?php checked( get_option( 'wpifw_download' ), $challan_current, true ); ?>>
                                                <label class="challan-custom-control-label tips"
                                                       for="wpifw_download"
                                    ...
                                    <!--  Allow to download invoice from my account base on order status.-->
                                    <div class="challan-form-group" id="downloadAttechedData" style="display:
									<?php
									...
									?>
                                            ">
                                        <div class="challan-custom-checkbox-label"></div>
                                        <div class="challan-custom-checkbox-container">
                                            <div class="challan-custom-control challan-custom-checkbox">

                                                <input type="checkbox" name="wpifw_invoice_download_check_list[]"
                                                       class="challan-custom-control-input" id="downloadChecked1"
                                                       value="processing"
													<?php
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                ...
                                                <input type="checkbox" name="wpifw_invoice_download_check_list[]"
                                                       class="challan-custom-control-input" id="downloadChecked2"
                                                       value="completed"
													<?php
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                <input type="checkbox" name="wpifw_invoice_download_check_list[]"
                                                       class="challan-custom-control-input" id="downloadChecked3"
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                ...
                                                <input type="checkbox" name="wpifw_invoice_download_check_list[]"
                                                       class="challan-custom-control-input" id="downloadChecked4"
                                                       value="always_allow"
													<?php
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Invoice Attach to Email', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            ...
                                            <div class="challan-toggle-container"
                                                ...
                                                <input type="checkbox" id="atttoorder"
                                                       class="challan-custom-control-input atttoorder"
                                                       name="wpifw_order_email"
                                                       value="1" <?php checked( get_option( 'wpifw_order_email' ), $challan_current, true ); ?>>
                                                <label class="challan-custom-control-label tips"
                                    ...
                                    <!-- Attach Invoice with email based on order status.-->
                                    <div class="challan-form-group" id="emailAttechedData" style="display:
									<?php
									...
									?>
                                            ">
                                        <span class="challan-custom-checkbox-label"></span>
                                        <div class="challan-custom-checkbox-container">
                                            <div class="challan-custom-control challan-custom-checkbox">

                                                <input type="checkbox" name="wpifw_email_attach_check_list[]"
                                                       class="challan-custom-control-input" id="emailChecked1"
                                                       value="new_order"
													<?php
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                ...
                                                <input type="checkbox" name="wpifw_email_attach_check_list[]"
                                                       class="challan-custom-control-input" id="emailChecked6"
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                ...
                                                <input type="checkbox" name="wpifw_email_attach_check_list[]"
                                                       class="challan-custom-control-input" id="emailChecked5"
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                ...
                                                <input type="checkbox" name="wpifw_email_attach_check_list[]"
                                                       class="challan-custom-control-input" id="emailChecked7"
                                            ...
                                            <div class="challan-custom-control challan-custom-checkbox">
                                                ...
                                                <input type="checkbox" name="wpifw_email_attach_check_list[]"
                                                       class="challan-custom-control-input" id="emailChecked8"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Document Type HTML', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container"
                                                ...
                                                <input type="checkbox" id="atttoorder09"
                                                       class="challan-custom-control-input atttoorder09"
                                                       name="wpifw_output_type_html"
                                                       value="1" <?php checked( get_option( 'wpifw_output_type_html' ), $challan_current, true ); ?>>
                                                <label class="challan-custom-control-label tips"
                                    ...
                                    <div class="challan-form-group challan-template-select" tooltip=""
                                         flow="right">
                                        <label class="challan-custom-label"
                                               for="templateid"><?php esc_html_e( 'Invoice Template', 'webappick-pdf-invoice-for-woocommerce' ); ?></label>
                                        <a class="challan-btn challan-btn-primary" data-toggle="modal"
                                           data-target="#winvoiceModalTemplates"
                                           style="color:#fff"><?php esc_html_e( 'Select Template', 'webappick-pdf-invoice-for-woocommerce' ); ?></a>
                                        <div class="challan-modal fade" id="winvoiceModalTemplates" tabindex="-1"
                                             role="dialog" aria-hidden="true">
                                            <div class="challan-modal-dialog challan-modal-dialog-centered"
                                                 role="document">
                                                <div class="challan-modal-content">
                                                    <div class="challan-modal-card" data-toggle="lists"
                                                        ...
                                                        <div class="challan-card-body" style="height:650px">
                                                            <div class="challan-row">
                                                                <div class="challan-col-sm-4">
                                                                    <a href="#" class="challan-template-selection"
                                                                       data-template="invoice-1"><img
																		...
																		if ( 'invoice-1' === get_option( 'wpifw_templateid' ) ) {
																			echo esc_attr( $challan_style2 );
																		} else {
																			echo esc_attr( $challan_style );
																		}
																		?>
                                                                                "></a>
                                                                </div>
                                                                ...
                                                                <div class="challan-col-sm-4"
                                                                    ...
                                                                    <a href="#" class="challan-element-disable"
                                                                       data-template=""
                                                                    ...
                                                                    <a href="https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=challan_free"
                                                                       target="_blank"
                                                                ...
                                                                <div class="challan-col-sm-4"
                                                                    ...
                                                                    <a href="#" class="challan-element-disable"
                                                                       data-template=""
                                                                       style="position: absolute;top: 0;z-index: 3333;"><img
                                                                                src="<?php echo esc_attr( CHALLAN_FREE_PLUGIN_URL . 'admin/images/templates/invoice-8.png' ); ?>"
                                                                                alt=""
                                                                                style="max-width:80%;display:block;margin:0 auto;border: 3px solid #0F74A6;"></a>
                                                                    <div style="width: 80%;height: 281px;position: absolute;top: 0;z-index:1111;background: #ddd;opacity: 0.7;margin-left: 25px;"></div>
                                                                    <a href="https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=challan_free"
                                                                ...
                                                                <div class="challan-col-sm-4"
                                                                    ...
                                                                    <a href="#" class="challan-element-disable"
                                                                       data-template=""
                                                                       style="position: absolute;top: 0;z-index: 3333;"><img
                                                                                src="<?php echo esc_attr( CHALLAN_FREE_PLUGIN_URL . 'admin/images/templates/invoice-9.png' ); ?>"
                                                                                alt=""
                                                                                style="max-width:80%;display:block;margin:0 auto;border: 3px solid #0F74A6;"></a>
                                                                    <div style="width: 80%;height: 281px;position: absolute;top: 0;z-index:1111;background: #ddd;opacity: 0.7;margin-left: 25px;"></div>
                                                                    <a href="https://webappick.com/plugin/woocommerce-pdf-invoice-packing-slips/?utm_source=customer_site&utm_medium=free_vs_pro&utm_campaign=challan_free"
                                                        ...
                                                        <div class="challan-card-footer">
                                                            <button class="challan-btn challan-btn-primary"
                                    ...
                                    </div><!-- end .challan-template -->

                                    <div class="challan-form-group" tooltip="" flow="right">
                                        <label class="challan-custom-label"
                                               for="challan_paper_size"> <?php esc_html_e( 'Paper Size', 'webappick-pdf-invoice-for-woocommerce' ); ?></label>
                                        <select class="challan-fixed-width challan-select-control"
                                                id="challan_paper_size" name="wpifw_invoice_paper_size">
                                    ...
                                    <div class="challan-form-group" tooltip="" flow="right">
                                        ...
                                        <input class="challan-fixed-width challan-form-control challan-number-input"
                                    ...
                                    <div class="challan-form-group" tooltip="" flow="right">
                                        ...
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group" tooltip="Keep Empty for no limit" flow="right">
                                        <label class="challan-custom-label"
                                               for="title-limit"><?php esc_html_e( 'Product Title limit', 'webappick-pdf-invoice-for-woocommerce' ); ?></label>
                                        <input class="challan-fixed-width challan-number-input challan-form-control"
                                    ...
                                    <div class="challan-form-group" tooltip="" flow="right">
                                        ...
                                        <select class="challan-fixed-width challan-select-control" id="disid"
                                                name="wpifw_disid">
                                    ...
                                    <!--=======================================================================-->
                                    <div class="challan-form-group" tooltip=""
                                         flow="right">
                                        <label class="challan-custom-label"
                                        ...
                                        <select id="wpifw_invoice_display_shipping_total"
                                                ...
                                                class="challan-fixed-width challan-select-control">
                                    ...
                                    <div class="challan-form-group" tooltip="" flow="right">
                                        ...
                                        <select class="challan-fixed-width challan-select-control" id="date"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Display Currency Code', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container" tooltip="" flow="right">
                                                <input type="hidden" name="wpifw_currency_code" value="0">
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       id="discurrency" name="wpifw_currency_code"
                                                       value="1" <?php checked( get_option( 'wpifw_currency_code' ), $challan_current, true ); ?> >
                                                <label class="challan-custom-control-label"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Display Payment Method', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container" tooltip="" flow="right">
                                                <input type="hidden" name="wpifw_payment_method_show" value="0">
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       id="disPayment" name="wpifw_payment_method_show"
                                                       value="1" <?php checked( $wpifw_payment_method_show, $challan_current, true ); ?> >
                                                <label class="challan-custom-control-label"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Display Order Note', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container" tooltip="" flow="right">
                                                <input type="hidden" name="wpifw_show_order_note" value="0">
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       id="wpifw_show_order_note" name="wpifw_show_order_note"
                                                       value="1" <?php checked( $wpifw_show_order_note, $challan_current, true ); ?> >
                                                <label class="challan-custom-control-label"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Enable Debug Mode', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container"
                                                ...
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       ...
                                                       value="1" <?php checked( get_option( 'wpifw_pdf_invoice_debug_mode' ), $challan_current, true ); ?> >
                                                <label class="challan-custom-control-label"
                                    ...
                                    <div class="challan-card-footer challan-save-changes-selector">
                                        <input style="float:right;" class="challan-btn challan-btn-primary"
                                               type="submit" name="wpifw_submit"
                                               value="<?php esc_html_e( 'Save Changes', 'webappick-pdf-invoice-for-woocommerce' ); ?>"/>
                                    </div><!-- end .challan-card-footer -->
                                </form>
                            </div><!-- end .challan-card-body -->
                        </div><!-- end .challan-card -->
                    </div><!-- end .challan-col-sm-8 -->

                    <div class="challan-col-sm-4 challan-col-12">
                        <div class="challan-card">
                            <div class="challan-card-header">
                                <h4><?php esc_html_e( 'SELECTED TEMPLATE', 'webappick-pdf-invoice-for-woocommerce' ); ?></h4>
                            </div><!-- end .challan-card-header -->
                            <div class="challan-card-body" style="text-align: center">
								<?php $template_name = get_option( 'wpifw_templateid' ); ?>
                                <img class="challan-template-preview"
            ...
            <li>
                <div class="challan-row">
                            ...
                            <div class="challan-card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="challan-form-group">
                                        ...
                                        <input class="challan-uploaded-logo-width challan-fixed-width challan-form-control"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Disable Phone Number', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container" tooltip="Disable Phone Number."
                                                 flow="right">
                                                <input type="hidden" name="wpifw_display_phone" value="0">
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       id="wpifw_display_phone" name="wpifw_display_phone"
                                                       value="1" <?php checked( get_option( 'wpifw_display_phone' ), $challan_current, true ); ?>>
                                                <label class="challan-custom-control-label"
                                    ...
                                    <div class="challan-form-group">
                                        <div class="challan-custom-control challan-custom-switch"
                                             style="padding-left:0!important;">
                                            <div class="challan-toggle-label">
                                                <span class="challan-checkbox-label"><?php esc_html_e( 'Disable Email Address', 'webappick-pdf-invoice-for-woocommerce' ); ?></span>
                                            </div>
                                            <div class="challan-toggle-container" tooltip="Disable Email Address."
                                                 flow="right">
                                                <input type="hidden" name="wpifw_display_email" value="0">
                                                <input type="checkbox" class="challan-custom-control-input"
                                                       id="wpifw_display_email" name="wpifw_display_email"
                                                       value="1" <?php checked( get_option( 'wpifw_display_email' ), $challan_current, true ); ?>>
                                                <label class="challan-custom-control-label"
                                    ...
                                    <div class="challan-card-footer challan-save-changes-selector">
                                        <input type="submit" style="float:right;" name="wpifw_submit_seller&buyer"
                                               value="<?php esc_html_e( 'Save Changes', 'webappick-pdf-invoice-for-woocommerce' ); ?>"
                                               class="challan-btn challan-btn-primary"/>
                                    </div><!-- end .challan-card-footer -->
                                </form>
                    ...
                    <div class="challan-col-sm-4">
                        <div class="challan-card">
                            <div class="challan-card-header">
                                <div class="challan-card-header-title">
                            ...
                            <div class="challan-card-body">
                                <div class='wpifw_logo-preview-wrapper'>
									...
									if ( get_option( 'wpifw_logo_attachment_image_id' ) && ! empty( get_option( 'wpifw_logo_attachment_image_id' ) ) ) {
										$challan_url = wp_get_attachment_url( get_option( 'wpifw_logo_attachment_image_id' ) );
										?>
                                        <img style="max-width:90px;display: block;margin:0 auto;"
                                             id='wpifw_logo-preview' src='<?php echo esc_url( $challan_url ); ?>'>
										<?php
									} else {
										?>
                                        <img style="max-width:90px;display: block;margin:0 auto;"
                        ...
                        <div class="challan-card challan-mr-0">
                            <div class="challan-card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="invoice">Invoice</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="payment_method">Payment
                                            Method</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="Invoice-number">Invoice
                                            Number</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="Invoice-date">Invoice Date</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="order_number">Order Number</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="order_date">Order Date</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="sl">SL</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                               id="sl" name="wpifw_SL"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="product">Product</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="price">Price</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="quantity">Quantity</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="total">Total</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="su-total">Sub Total</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="Tax1">Tax</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="discount">Discount</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="grand-total-tax">REFUNDED</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="shipping">SHIPPING</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="grand-total-tax">Grand
                                            Total</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label challan-download-invoice"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="packing_slip">Packing Slip</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="Invoice-number_slip">Order
                                            Number</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="Invoice-date">Order Date</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="shipping_method">Shipping
                                            method</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                                    ...
                                    <div class="challan-form-group">
                                        <label class="challan-custom-label" for="weight">Weight</label>
                                        <input class="challan-fixed-width challan-form-control" type="text"
                            ...
                            <div class="challan-card-body">
                                <form action="" method="post" target="_blank">
                                    ...
                                    <div class="challan-form-group">
                                        ...
                                        <input class="challan-fixed-width challan-datepicker challan-form-control"
                        ...
                        <div class="challan-card challan-mr-0">
                            <div class="challan-card-body">
                                <form enctype="multipart/form-data">
                                    <div class="challan-row">
                                        <div class="challan-col-9">
                                            <div class="challan-form-group">
                                                <label class="challan-custom-label"
                                                       for="challan-font-upload"> <?php esc_html_e( 'Upload Fonts', 'webappick-pdf-invoice-for-woocommerce' ); ?></label>
                                                <input type="file" class="form-control-file"
                                                       id="challan-font-upload"/>
                                            </div><!-- end .challan-form-group -->
                                        </div>
                                        <div class="challan-col-1">
                                        ...
                                        <div class="challan-col-2">
                                            <a style="color:#fff" id="wpifw_pdf_invoice_download_font"
                                               class="challan-button challan-button-primary"
                                ...
                                <div class="challan-card-footer" style="margin-top:25px">
                        ...
                        <div class="challan-card challan-mr-0">
                            <div class="challan-card-body">
                                <table class="system-status-table">
									...
									$chalan_plugin_data = get_plugin_data( CHALLAN_FREE_FILE );
                        ...
                        <div class="challan-card challan-mr-0">
                            <div class="challan-card-body">
                                <table width="100%">
									...
									foreach ( $challan_comparetable as $invoice_feature ) {
										?>
                                        <tr>
                                            <td class="challan-proFree-feature"><?php printf( esc_html__( '%1$s', 'webappick-pdf-invoice-for-woocommerce' ), $invoice_feature['title'] ); //phpcs:ignore ?></td>
											<?php if ( false === $invoice_feature['free'] ) { ?>
                                                <td class="challan-proFree-free"><span
                                                            class="dashicons dashicons-no"></span></td>
											<?php } else { ?>
                                                <td class="challan-proFree-pro"><span
    ...
    </div><!-- end .challan-dashboard-content -->
</div><!-- end .challan-dashboard-body -->