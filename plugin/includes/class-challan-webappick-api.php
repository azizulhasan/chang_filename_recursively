 ...
 *
 * @package    Challan_ProWebAppickAPI
 * @since   1.2.2
 * @version 1.0.0
 */
...
if ( ! class_exists( 'Challan_WebAppickAPI' ) ) {
	/**
	 * Class Challan_WebAppickAPI
	 */
	final class Challan_WebAppickAPI {
		...
		private function __construct() {
			...
			$this->client = new WebAppick\AppServices\Client( '28261c3c-793e-4c74-bf7f-2837b8c6ddb4', 'Challan Free', CHALLAN_FREE_FILE );
			// Load.
